...
const items: Item[] = [
  ...
  { href: "/panel/pedidos", label: "Pedidos", icono: FileText, roles: ["ADMIN", "VENTAS", "FABRICA"], proximamente: "Fase 5" },
  { href: "/panel/fabrica", label: "Fábrica", icono: Hammer, roles: ["ADMIN", "VENTAS", "FABRICA"], proximamente: "Fase 5" },
